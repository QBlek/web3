...
app.post('/api/issueTicket', async (req, res) => {
    ...
    try {
        ...
        await query('INSERT INTO ticket_info_old(TICKET_NO, CONCERT_NAME, TICKET_PRICE, TICKET_OWNER, TICKET_ISSUED, TICKET_PURCHASED, TICKET_STATE) VALUES(?,?,?,?,?,?,?)', [newTicketNumber, _ticket_info, _ticket_price, _ticket_owner, _issued_date, _purchased_date, _state]);
...
app.post('/api/purchaseTicket', async (req, res) => {
    ...
    try {
        ...
        await query('UPDATE ticket_info_old SET TICKET_OWNER = ?, TICKET_PURCHASED = ?, TICKET_STATE = ? WHERE TICKET_NO = ?', [_ticket_owner, _purchased_date, _state, ticket_no]);
        console.log('----------Ticket Information----------')
        console.log('_ticket_owner: ', _ticket_owner);
        console.log('_state: ', _state);
        console.log('_ticket_price: ', _ticket_price);
...
app.post('/api/checkTicket', async (req, res) => {
    ...
    try {
        ...
        await query('UPDATE ticket_info_old SET TICKET_STATE = ? WHERE TICKET_NO = ?', [_state, ticket_no]);
        console.log('----------Ticket Information----------')
        console.log('_ticket_owner: ', _ticket_owner);
        console.log('_state: ', _state);
        console.log('_ticket_price: ', _ticket_price);
...
app.post('/api/checkRefundedTicket', async (req, res) => {
    ...
    try {
        ...
        await query('UPDATE ticket_info_old SET TICKET_STATE = ? WHERE TICKET_STATE = ?', ['ISSUED', 'REFUNDED']);
